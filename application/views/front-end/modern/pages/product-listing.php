                                ...
                                <div class="d-flex py-4" title="<?= $row['name']; ?>">
                                            ...
                                            <div class="product-image item">
                                                <figure class="rounded">
                                                    <a href="<?= base_url('products/details/' . $row['slug']) ?>">
                                                        <img class="pic-1 lazy fig_image w-100" src="<?= base_url('assets/front_end/modern/img/product-placeholder.jpg') ?>" data-src="<?= $row['image_sm'] ?>" style="object-fit: cover;">
                                                    </a>
                                    ...
                                    <div class="col-7 col-md-8">
                                        <div class="product-content product_listing_list">
                                            <h4 class="list-product-title title" title="<?= $row['name']; ?>">
                                            ...
                                            <div class="button button-sm m-0 p-0">
                                                ...
                                                ?>
                                                <a href="#" class="add_to_cart  btn btn-xs btn-outline-primary rounded-pill" data-product-id="<?= $row['id'] ?>" data-product-variant-id="<?= $variant_id ?>" data-product-title="<?= $row['name'] ?>" data-product-slug="<?= $row['slug'] ?>" data-product-image="<?= $row['image']; ?>" data-product-price="<?= $variant_price; ?>" data-min="<?= $data_min; ?>" data-step="<?= $data_step; ?>" data-product-description="<?= short_description_word_limit(output_escaping(str_replace('\r\n', '&#13;&#10;', strip_tags($row['short_description'])))); ?>" data-izimodal-open="<?= $modal ?>">
                                                    <i class="uil uil-shopping-bag"></i>&nbsp;<?= !empty($this->lang->line('add_to_cart')) ? $this->lang->line('add_to_cart') : 'Add To Cart' ?></a>
                                                       <script>
                                                            var productId = <?php echo json_encode($row['id']); ?>;
                                ...
                                <div class="row ">
                                    ...
                                    ?>
                                        <div class="project item col-6 col-xl-4 default-style my-2" title="<?= $row['name']; ?>">
                                            <div class="swiper-slide shadow-xl product-bg">
                                                <figure class="rounded">
                                                    <a href="<?= base_url('products/details/' . $row['slug']) ?>">
                                                        <img class="pic-1 lazy fig_image" src="<?= base_url('assets/front_end/modern/img/product-placeholder.jpg') ?>" data-src="<?= $row['image_sm'] ?>" style="object-fit: cover;">
                                                    </a>
                                                    <a class="item-like text-decoration-none add-to-fav-btn 
                                                            <?= ($row['is_favorite'] == 1) ? 'fa fa-heart' : 'fa fa-heart-o' ?>  
                                                            " href="#" data-bs-toggle="white-tooltip" title="Add to wishlist" data-product-id="<?= $row['id'] ?>" style="color: <?= ($row['is_favorite'] == 1) ? 'red' : '' ?>">
                                                ...
                                                <div class="my-4 style_4 px-3 post-header">
                                                    ...
                                                    <?php } ?>
                                                    <a href="#" class="add_to_cart  btn btn-xs btn-outline-primary rounded-pill mt-2 w-100" data-product-id="<?= $row['id'] ?>" data-product-variant-id="<?= $variant_id ?>" data-product-title="<?= $row['name'] ?>" data-product-slug="<?= $row['slug'] ?>" data-product-image="<?= $row['image']; ?>" data-product-price="<?= $variant_price; ?>" data-min="<?= $data_min; ?>" data-step="<?= $data_step; ?>" data-product-description="<?= short_description_word_limit(output_escaping(str_replace('\r\n', '&#13;&#10;', strip_tags($row['short_description'])))); ?>" data-izimodal-open="<?= $modal ?>">
                                                    <i class="uil uil-shopping-bag"></i>&nbsp;<?= !empty($this->lang->line('add_to_cart')) ? $this->lang->line('add_to_cart') : 'Add To Cart' ?></a>
                    ...
                    <div class="row">
                        <div class=" order-md-1 filter-section sidebar-filter-sm pt-2 pb-2 filter-sidebar-view">
                            <?php if (isset($products['filters']) && !empty($products['filters'])) { ?>
                                ...
                                <div class="filter-option-title align-content-center  d-flex justify-content-between">
                                    <h6 class="m-0"><?= label('attributes', 'Attributes') ?></h6>
                                    <a href="#" class="text-decoration-none hover product_filter_btn"><?= !empty($this->lang->line('filter')) ? $this->lang->line('filter') : '' ?></a>
                                </div>
                                <div id="product-filters-desktop" class="filter_attributes mb-2 mt-2">
                            ...
                            <?php } ?>
                             <div class='filter-option'> 
                            <div id="brand-filters-desktop" class="filter_brands mt-2">
                                <?php if (isset($brands) && !empty($brands)) { ?>
                                    <div class="filter-option-title align-content-center d-flex justify-content-between">
                                        <h6 class="m-0"><?= label('brands', 'Brands') ?></h6>
                                        <a href="#" class="text-decoration-none hover product_filter_btn"><?= !empty($this->lang->line('filter')) ? $this->lang->line('filter') : '' ?></a>
                                    </div>
                                    <div class="brand_filter d-flex flex-wrap gap-4 mb-3 mt-2 p-1">
                                        <?php
