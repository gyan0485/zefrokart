...
$allow_items_in_cart = get_settings('system_settings', true);
?>
<!-- header starts -->
            ...
            <aside class="sidebar">
                <div id="leftside-navigation" class="nano">
                    <ul class="nano-content">
                        ...
                        <li><a href="<?= base_url('sellers') ?>"><i class="fas fa-store fa-lg"></i><span class="ml-1"><?= !empty($this->lang->line('sellers')) ? $this->lang->line('sellers') : 'Sellers' ?></a></li>
