                    ...
                    <?php if (isset($sliders) && !empty($sliders)) { ?>
                        <?php foreach ($sliders as $row) { ?>
                            <div class="swiper-slide center-swiper-slide">
                                <a href="<?= $row['link'] ?>">
                                    <img  alt='indian artificial jewellery online, jewellery manufacturers' src="<?= base_url($row['image']) ?>">
                                </a>
                            </div>
                        <?php } ?>
                    <?php } ?>
                            ...
                            <div class="category-image">
                                <div class="category-image-container">
                                    <a href="<?= base_url('products/category/' . html_escape($row['slug'])) ?>">
                                        <img alt='artificial jewellery shop,artificial jewellery wholesale' src="<?= $row['image'] ?>">
                                    </a>
        ...
        if (!empty($row['product_details'])) {
            if ($row['style'] == 'default') {
                if ($count_key != 0) {
                    ...
                    if (!empty($offers) && !empty($offers[$count_key - 1])) { ?>
                        <a href="<?= $offers[$count_key - 1]['link'] ?>">
                            <img class="img-fluid lazy" alt='steak and ale pie' data-src="<?= base_url($offers[$count_key - 1]['image']) ?>">
                        </a>
                <?php }
                } ?>
                                            ...
                                            <div class="product-image">
                                                <div class="product-image-container">
                                                    <a href="<?= base_url('products/details/' . $product_row['slug']) ?>">
                                                        <img alt='artificial jewellery products,artificial jewellery wholesale product' class="pic-1" src="<?= $product_row['image_sm'] ?>">
                                                    </a>
                                                </div>
                                                <ul class="social">
                                                    <li>
                ...
                if ($count_key != 0) {
                    if (!empty($offers) && !empty($offers[$count_key - 1])) { ?>
                        <a href="<?= $offers[$count_key - 1]['link'] ?>">
                            <img  alt='latest artificial jewellery designs,best artificial jewellery in Mumbai' class="img-fluid lazy" data-src="<?= base_url($offers[$count_key - 1]['image']) ?>">
                        </a>
                <?php }
                }
                ?>
                                    ...
                                    <div class="col-md-4">
                                        <div class="product-grid">
                                            ...
                                            <div class="product-image">
                                                <div class="product-image-container">
                                                    <a href="<?= base_url('products/details/' . $product_row['slug']) ?>">
                                                        <img  alt='best artificial jewellery in lucknow,imitation jewellery near me' class="pic-1 lazy" data-src="<?= $product_row['image_sm'] ?>">
                                                    </a>
                                                </div>
                                                <ul class="social">
                                                    <li>
                                ...
                                <div class="product-image-container d-flex align-items-center justify-content-center">
                                    <div>
                                        <a href="<?= base_url('products/details/' . $last_product['slug']) ?>">
                                            <img alt='best artificial jewellery in lucknow,imitation jewellery near me'  class="pic-1 lazy" data-src="<?= $last_product['image_sm'] ?>">
                                        </a>
                                    </div>
                                </div>
                                <ul class="social">
                ...
                if ($count_key != 0) {
                    if (!empty($offers) && !empty($offers[$count_key - 1])) { ?>
                        <a href="<?= $offers[$count_key - 1]['link'] ?>">
                            <img alt='best imitation jewellery online,fashion jewellery online'  class="img-fluid lazy" data-src="<?= base_url($offers[$count_key - 1]['image']) ?>">
                        </a>
                <?php }
                }
                ?>
                                ...
                                <div class="product-image-container d-flex align-items-center justify-content-center">
                                    <div>
                                        <a href="<?= base_url('products/details/' . $first_product['slug']) ?>">
                                            <img alt='polki jewellery,fashion jewellery online' class="pic-1 lazy" data-src="<?= $first_product['image_sm'] ?>">
                                        </a>
                                    </div>
                                </div>
                                <ul class="social">
                                ...
                                <div class="col-md-4 col-6">
                                    <div class="product-grid">
                                        ...
                                        <div class="product-image">
                                            <div class="product-image-container">
                                                <a href="<?= base_url('products/details/' . $product_row['slug']) ?>">
                                                    <img  alt='artificial jewellery,imitation jewellery in malad' class="pic-1 lazy" data-src="<?= $product_row['image_sm'] ?>">
                                                </a>
                                            </div>
                                            <ul class="social">
                                                <li>
                ...
                if ($count_key != 0) {
                    if (!empty($offers) && !empty($offers[$count_key - 1])) { ?>
                        <a href="<?= $offers[$count_key - 1]['link'] ?>">
                            <img alt='artificial jewellery,imitation jewellery in malad' class="img-fluid lazy" data-src="<?= base_url($offers[$count_key - 1]['image']) ?>">
                        </a>
                <?php }
                }
                ?>
            ...
            <div class="row">
                <div class="col-md-6 col-lg-4 offset-lg-1">
                    ...
                    <div class="mobile-app-wrapper">
                        <img  alt='artificial jewellery,imitation jewellery in malad' src="<?= THEME_ASSETS_URL . 'demo/avtars/4861083.jpg' ?>" alt="">
                    </div>
                ...
                <div class="col-md-6 col-lg-6">
                    <div class="text-area">
                        ...
                        <div class="mt-3">
                            <a href="<?= $web_settings['app_download_section_appstore_url'] ?>" target="_blank"><img alt='imitation jewellery shop near me,imitation jewellery online' src="<?= THEME_ASSETS_URL . 'demo/app-store/app-store.png' ?>" alt="" class="download_section" width="150"></a>
                            <a href="<?= $web_settings['app_download_section_playstore_url'] ?>" target="_blank"><img alt='imitation jewellery shop near me,imitation jewellery online' src="<?= THEME_ASSETS_URL . 'demo/app-store/google-play-store.png' ?>" alt="" class="download_section" width="150"></a>
                        </div>
                    </div>
                </div>
            </div> <!-- end of row -->
