    ...
    <div class="row mx-0">
                        ...
                        <div class='product-view-grid'>
                            <div class='product-view-image'>
                                <div class='product-view-image-container'>
                                    <img alt='artificial jewellery,imitation jewellery in malad' alt='artificial jewellery,imitation jewellery in malad' src="<?= $product['product'][0]['image'] ?>" id="img_01" data-zoom-image="">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    ?>
                                    <div class="swiper-slide">
                                        <div class='product-view-grid'>
                                            <div class='product-view-image'>
                                                <div class='product-view-image-container'>
                                                    <img alt='artificial jewellery,imitation jewellery in malad' src="<?= $image ?>" data-zoom-image="">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    ?>
                            <div class="swiper-slide">
                                <div class='product-view-grid'>
                                    <div class='product-view-image'>
                                        <div class='product-view-image-container'>
                                            <img alt='artificial jewellery,imitation jewellery in malad' src="<?= $other_image ?>" id="img_01" data-zoom-image="">
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="swiper-wrapper" id="gal1">
                    <div class="swiper-slide ml-0">
                        <div class='product-view-grid'>
                            <div class='product-view-image'>
                                <div class='product-view-image-container'>
                                    <img alt='artificial jewellery,imitation jewellery in malad' src="<?= $product['product'][0]['image'] ?>">
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        foreach ($product['product'][0]['other_images'] as $other_image) { ?>
                            <div class="swiper-slide ml-0">
                                <div class='product-view-grid'>
                                    <div class='product-view-image'>
                                        <div class='product-view-image-container'>
                                            <img alt='artificial jewellery,imitation jewellery in malad' src="<?= $other_image ?>">
                                        </div>
                                    </div>
                                </div>
                            </div>
        ...
        <div class="col-12 col-md-6 product-preview-image-section-sm">
            <div class=" swiper-container preview-image-swiper">
                <div class="swiper-wrapper">
                    <div class="swiper-slide text-center"><img alt='artificial jewellery,imitation jewellery in malad' src="<?= $product['product'][0]['image'] ?>"></div>
                    <?php
                    if (!empty($product['product'][0]['other_images']) && isset($product['product'][0]['other_images'])) {
                        foreach ($product['product'][0]['other_images'] as $other_image) { ?>
                            <div class="swiper-slide text-center"><img alt='artificial jewellery,imitation jewellery in malad' src="<?= $other_image ?>"></div>
                    <?php }
                    } ?>
                    <?php if (!empty($variant_images_md)) {
                        foreach ($variant_images_md as $variant_images) {
                            if (!empty($variant_images)) {
                                foreach ($variant_images as $image) {
                    ?>
                                    <div class="swiper-slide text-center"><img alt='artificial jewellery,imitation jewellery in malad' src="<?= $image ?>" data-zoom-image=""></div>
                        ...
                        <?php foreach ($attribute_values as $key => $row) {
                            ...
                            <?php } else if ($swatche_types[$key] == "2") { ?>
                                ...
                                <label class="btn text-center ">
                                    <img alt='artificial jewellery,imitation jewellery in malad' class="swatche-image" src="<?= $swatche_values[$key] ?>">
                                    <input type="radio" name="<?= $attribute['attr_name'] ?>" value="<?= $attribute_ids[$key] ?>" autocomplete="off" class="attributes">
                                    <br>
                                </label>
                            <?php } else { ?>
            ...
            <div class="tab-content p-3 w-100" id="nav-tabContent">
                                    ...
                                    foreach ($my_rating['product_rating'] as $row) { ?>
                                        <li class="review-container">
                                            <div class="review-image">
                                                <img alt='artificial jewellery,imitation jewellery in malad' src="<?= THEME_ASSETS_URL . 'images/user.png' ?>" alt="" width="65" height="65">
                                            </div>
                                                        ...
                                                        <div class="col-sm-2">
                                                            <div class="review-box">
                                                                <a href="<?= file_exists(FCPATH . REVIEW_IMG_PATH . $image) ? $image : base_url() . NO_IMAGE;  ?>" data-lightbox="review-images">
                                                                    <img alt='artificial jewellery,imitation jewellery in malad' src="<?= file_exists(FCPATH . REVIEW_IMG_PATH . $image) ? $image : base_url() . NO_IMAGE; ?>" alt="Review Image">
                                                                </a>
                                                            </div>
                                                        </div>
                                                    <?php } ?>
                ...
                <div class="tab-pane fade" id="product-seller" role="tabpanel" aria-labelledby="product-seller-tab">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-5">
                                <img alt='artificial jewellery,imitation jewellery in malad' src="<?= $product['product'][0]['seller_profile'] ?>" class=" product-image-container pic-1">
                            </div>
                            <div class="col-sm-6">
                            ...
                            <div class="product-image">
                                <div class="product-image-container">
                                    <a href="<?= base_url('products/details/' . $row['slug']) ?>">
                                        <img alt='artificial jewellery,imitation jewellery in malad' class="pic-1" src="<?= $row['image_sm'] ?>">
                                    </a>
                                </div>
                                <ul class="social">
                                    <li>
