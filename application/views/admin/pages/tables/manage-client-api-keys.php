                ...
                <div class="col-md-12">
                    <div class="card card-info">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="form-group col-md-4">
                                    <label for="name" class="control-label col-md-12">API link for Customer App(Chat feature)<small>( Use this link as your API link in App's code )</small></label>
                                </div>
                                <div class="form-group col-md-8">
                                    <input type="text" class="form-control" id="api_link" value="<?= base_url('app/v1/Chat_Api/'); ?>" disabled>
                                </div>
                            </div>
                            <div class="row">
                                <div class="form-group col-md-4">
                            ...
                            <div class="row">
                                <div class="form-group col-md-4">
                                    <label for="name" class="control-label col-md-12">API link for Seller App(Chat feature)<small>( Use this link as your API link in App's code )</small></label>
                                </div>
                                <div class="form-group col-md-8">
                                    <input type="text" class="form-control" id="api_link" value="<?= base_url('seller/app/v1/Chat_Api/'); ?>" disabled>
                                </div>
                            </div>
                        </div>
                    </div>
