                            ...
                            <div class="swiper swiper-thumbs swiper-vertical gallery-thumbs-1">
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide swiper-img mb-1" style="width: 114px; margin-right: 10px;">
                                        ...
                                        <img src="<?= base_url('assets/front_end/modern/img/product-placeholder.jpg') ?>" data-src="<?= base_url($product['product'][0]['relative_path']) ?>" class="rounded p-1 lazy">
                                    </div>
                                    <?php
                                            ...
                                            if (!empty($variant_images)) {
                                                foreach ($variant_images as $image) { ?>
                                                    <div class="swiper-slide  swiper-img mb-1" style="width: 114px; margin-right: 10px;">
                                                        ...
                                                        <img src="<?= base_url('assets/front_end/modern/img/product-placeholder.jpg') ?>" data-src="<?= base_url($image) ?>" class="rounded p-1 lazy" alt="">
                                                    </div>
                                    <?php }
                                            }
                                        }
                                            ...
                                            <div class="swiper-slide  swiper-img mb-1" style="width: 114px; margin-right: 10px;">
                                                <!-- <img src="<? //= base_url('assets/front_end/modern/img/product-placeholder.jpg') 
                                                                ?>" data-src="<? //= $other_image 
                                                                                ?>" class="rounded p-1 lazy" alt=""> -->
                                                <img src="<?= base_url('assets/front_end/modern/img/product-placeholder.jpg') ?>" data-src="<?= base_url($other_image) ?>" class="rounded p-1 lazy" alt="">
                                            </div>
                                    <?php }
                                    } ?>
                                    <?php
                                ...
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <figure class="rounded">
                                            ...
                                            <img src="<?= base_url('assets/front_end/modern/img/product-placeholder.jpg') ?>" data-src="<?= base_url($product['product'][0]['relative_path']) ?>" alt="" class="lazy" style="object-fit: contain;height: 450px !important;width: fit-content;">
                                            <a class="item-link text-decoration-none" href="<?= $product['product'][0]['image_sm'] ?>" data-glightbox="" data-gallery="product-group"><i class="uil uil-focus-add"></i></a>
                                        </figure>
                                    </div>
                                    <?php
                                    // $variant_images_md = array_column($product['product'][0]['variants'], 'images_md');
                                    ...
                                    ?>
                                                    <div class="swiper-slide 12345">
                                                        <figure class="rounded">
                                                            ...
                                                            <img src="<?= base_url('assets/front_end/modern/img/product-placeholder.jpg') ?>" data-src="<?= base_url($image) ?>" class="lazy" alt="" style="object-fit: contain;height: 450px !important;width: fit-content;">
                                    ...
                                    ?>
                                            <div class="swiper-slide">
                                                <figure class="rounded">
                                                    ...
                                                    <img src="<?= base_url('assets/front_end/modern/img/product-placeholder.jpg') ?>" data-src="<?= base_url($other_image) ?>" class="lazy" alt="" id="img_01" style="object-fit: contain;height: 450px !important;width: fit-content;">
                ...
                <div class="product-preview-image-section-sm overflow-auto">
                    <div class="swiper swiper-container preview-image-swiper">
                        <div class="swiper-wrapper">
                            ...
                            <div class="swiper-slide text-center"><img class="lazy" src="<?= base_url('assets/front_end/modern/img/product-placeholder.jpg') ?>" data-src="<?= base_url( $product['product'][0]['relative_path']) ?>"></div>
                            <?php
                            // if (!empty($product['product'][0]['other_images']) && isset($product['product'][0]['other_images'])) {
                            //     foreach ($product['product'][0]['other_images'] as $other_image) { 
                            // if (!empty($product['product'][0]['other_images_sm']) && isset($product['product'][0]['other_images_sm'])) {
                            ...
                            ?>
                                    <div class="swiper-slide text-center">
                                        <!-- <img class="lazy" src="<? //= base_url('assets/front_end/modern/img/product-placeholder.jpg') 
                                                                    ?>" data-src="<? //= $other_image 
                                                                                    ?>"> -->
                                        <img class="lazy" src="<?= base_url('assets/front_end/modern/img/product-placeholder.jpg') ?>" data-src="<?= base_url($other_image) ?>">
                                    </div>
                            <?php }
                            } ?>
                            <?php
                            ...
                            ?>
                                            <div class="swiper-slide text-center">
                                                <!-- <img class="lazy" src="<? //= base_url('assets/front_end/modern/img/product-placeholder.jpg') 
                                                                            ?>" data-src="<? //= $image 
                                                                                            ?>" data-zoom-image=""> -->
                                                <img class="lazy" src="<?= base_url('assets/front_end/modern/img/product-placeholder.jpg') ?>" data-src="<?= base_url( $image) ?>" data-zoom-image="">
                                            </div>
            ...
            <div class="col-md-5">
                <div class="post-header mb-5">
                    ...
                    <?php if ($product['product'][0]['type'] == "simple_product") { ?>
                        ...
                        <p class="my-1 price d-none" id="price">
                            <?php echo $settings['currency'] ?>
                    ...
                    <div class="col-lg-10 d-flex flex-row pt-2 gap-1 product-page-div p-0">
                        ...
                        if (isset($settings['whatsapp_status']) && $settings['whatsapp_status'] == 1 && isset($settings['whatsapp_number'])) { ?>
                            <a href="https://api.whatsapp.com/send?phone= <?= ($settings['whatsapp_number'] != '' && isset($settings['whatsapp_number'])) ? $settings['whatsapp_number'] : ((!defined('ALLOW_MODIFICATION') && ALLOW_MODIFICATION == 0)  ? str_repeat("X", strlen($settings['whatsapp_number']) - 3) . substr($settings['whatsapp_number'], -3) : $settings['whatsapp_number'])   ?> &amp;text=Hello, I Seen This <?= $product['product'][0]['name'] ?> In Your Website And I Want to Buy This" target="_blank" title="Order From Whatsapp" class=" btn btn-success  btn-outline-blue btn-icon btn-sm rounded-pill w-15 p-0">
