    ...
    <section class="chat-section">
        <div class="main-content">
            ...
            <div class="container mt-2">
                <h1><?= !empty($this->lang->line('chat')) ? $this->lang->line('chat') : 'Chat'; ?></h1>
            </div>
                        ...
                        <div class="card chat-theme-light chat-scroll chat-min">
                            ...
                            <div id="add-scroll-js ">
                                <div class="card-header chat-card-header text-color mt-4">
                                    <h4 class="fw-semibold"><?= !empty($this->lang->line('personal_chat')) ? $this->lang->line('personal_chat') : 'Personal Chat'; ?></h4>
                                </div>
