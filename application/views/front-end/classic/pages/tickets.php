        ...
        <div class="row">
            ...
            <div class="col-md-9 padding-16-30 home_faq">
                <div class="align-items-center d-flex flex-wrap justify-content-between pb-3">
                    ...
                    <button type="submit" class="btn btn-primary viewmorebtn ticket_button" value="Save"><?= !empty($this->lang->line('create_a_ticket')) ? $this->lang->line('create_a_ticket') : 'Create a ticket' ?></button>
                </div>
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <form class="form-horizontal form-submit-event card" id="stock_adjustment_form" method="POST" enctype="multipart/form-data" action="<?= base_url('tickets/update_ticket'); ?>">
                                                    <div>
                                                        ...
                                                        <label class=""><?= !empty($this->lang->line('email')) ? $this->lang->line('email') : 'Email' ?>" name="email" value="<?= $data['email'] ?></label>
                                                        ...
                                                        <label class=""><?= !empty($this->lang->line('subject')) ? $this->lang->line('subject') : 'Subject' ?>" name="subject" value="<?= $data['subject'] ?></label>
                                                        ...
                                                        <label class=""><?= !empty($this->lang->line('description')) ? $this->lang->line('description') : 'Description' ?>" name="description" value="<?= $data['description'] ?></label>
