                        ...
                        <?php foreach ($sliders as $row) { ?>
                            <div class="swiper-slide center-swiper-slide">
                                <a href="<?= $row['link'] ?>">
                                    ...
                                    <img src="<?= base_url('media/image?path='.$row['image'].'&width=1518&quality=100') ?>">
                                </a>
                            </div>
                        <?php } ?>
                    <?php } ?>
                            ...
                            <div class="category-image">
                                <div class="category-image-container">
                                    <a href="<?= base_url('products/category/' . html_escape($row['slug'])) ?>">
                                        <!-- <img src="<?= $row['image'] ?>"> -->
                                        <img src="<?= base_url('media/image?path='. $row['relative_path'] .'&width=130&quality=100') ?>">
                                    </a>
                        ...
                        <div class="swiper-slide swiper-slide-brand">
                            <a href="<?= base_url('products?brand=' . html_escape($row['brand_slug'])) ?>" class="text-decoration-none">
                                <div class="brand_image">
                                    <img class="lazy brand_img" src="<?= base_url('assets/front_end/modern/img/product-placeholder.jpg') ?>" data-src="<?= base_url('media/image?path='.$row['brand_img'].'&width=100&quality=100') ?>" alt="<?= html_escape($row['brand_name']) ?>" />
                                </div>
                ...
                if ($count_key != 0) {
                    ...
                    if (!empty($offers) && !empty($offers[$count_key - 1])) { ?>
                        <a href="<?= $offers[$count_key - 1]['link'] ?>">
                            <img class="img-fluid lazy" data-src="<?= base_url('media/image?path='.$offers[$count_key - 1]['image'].'&width=1518&quality=100') ?>">
                        </a>
                <?php }
                } ?>
