                ...
                <div class="col-md-12 main-content">
                    <div class="card content-area p-4">
                        ...
                        <div class="card-innr">
                            ...
                            <p>
                                <lable class="badge badge-info mt-4" style="font-size:14px;">Note : If you found seller commission not crediting using cron job you can update seller commission manually from here! ( click on update seller commission button )</lable>
                            </p>
