...
<section class="wrapper bg-light">
    <div class="container pt-5 pt-md-5 mb-15">
            ...
            <div class="row gx-md-8 gx-xl-12 gy-12">
                <div class="col-lg-8">
                    ...
                    <div class="bg-white mt-5">
                        ...
                        <div class="ship-details-wrapper -ress-details">
                            ...
                            <?php if ($cart[0]['type'] != 'digital_product') { ?>
                                <div class="align-item-center ship-title-details justify-content-between user-add d-flex">
                                    <!--<h5 class="pb-3"><?= !empty($this->lang->line('shipping_address')) ? $this->lang->line('shipping_address') : 'Shipping Address' ?></h5>-->
                                     ...
                                     <h5 class="pb-3"> <a href="#" class="float-end " data-bs-toggle="modal" data-bs-target="#add-address-modal">
                            <?='+ Add Address' ?>
                        </a></h5>
                        
                        
                          <h6 class="pb-3"> <a href="#" class="float-end " data-bs-toggle="modal" data-bs-target="#address-modal"> 
                            <?= 'Change Address' ?>
                            </a></h6>
                                ...
                                <div class="shipped-details mt-3">
                                    ...
                                    <p class="text-muted m-0" id="address-full"><?= isset($default_address) && !empty($default_address) ? $default_address[0]['address'] . ' , ' . $default_address[0]['city'] : '' ?></p>
                                ...
                                <div id="deliverable_status">
                                    ...
                                    if (isset($default_address) && !empty($default_address)) {
                                        ...
                                        $product_delivarable = check_cart_products_delivarable($cart[0]['user_id'],'1', $default_address[0]['pincode'], $zipcode_id);
                           ...
                           <div class="shipped-details mt-3">
                                ...
                                <!--    <tbody>-->
                                        <?php if (isset($payment_methods['cod_method']) && $payment_methods['cod_method'] == 1) { ?>
                                             <div class="payment-option highlighted-radio">
                                                <label class="d-flex align-items-center" for="cod">
                                                    <div class="p-2">
                                                            <input id="cod" class="form-check-input position-static" title="<?= isset($cart[0]['is_cod_allowed']) && $cart[0]['is_cod_allowed'] == 0 ? 'Cash on delivery is not allowed for one of the item in your cart' : 'Please select one of this options.' ?>" name="payment_method" type="radio" value="COD" <?= isset($cart[0]['is_cod_allowed']) && $cart[0]['is_cod_allowed'] == 0 ? 'disabled' : '' ?>>
                                                        </div>
                                                    <div class="p-2">
                                        ...
                                        <?php if (isset($payment_methods['razorpay_payment_method']) && $payment_methods['razorpay_payment_method'] == 1) { ?>
                                             <div class="payment-option highlighted-radio">
                                                 <label class="d-flex align-items-center" for="razorpay">
                                                     
                                                     
                                                <div class="p-2">
                                                        <input id="razorpay" class="form-check-input position-static" name="payment_method" type="radio" value="Razorpay">
                                                    </div>
                                               <div class="p-2">
                                        ...
                                        <div class="payment-option highlighted-radio">
                                            <label class="d-flex align-items-center" for="phonepe">
                                                
                                                <div class="p-2">
                                                        <input id="phonepe" class="form-check-input position-static" name="payment_method" type="radio" value="phonepe">
                                                    </div>
                                                <div class="p-2">
                    ...
                    <div class="checkout-order-wrapper">
                        ...
                        <div class="order-details">
                            <div class="product-checkout-wrapper">
                                    ...
                                    <table class="table cart-products-table">
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="text-end">
                                                    <p class="price  gap-1"><?= $settings['currency'] . ' <span class="sub_total">' . format_price($cart['sub_total']) . '</span>' ?></p>
                                                </td>
                                            </tr>
                                                ...
                                                <tr class="all-delivery-charges">
                                                    <td colspan="2">
                                                        ...
                                                        <div class="d-flex justify-content-between">
                                                            <div class="delivery_charge">
                                                                <h6 class="fs-15">
                                                                    <?= !empty($this->lang->line('estimate_date')) ? $this->lang->line('estimate_date') : 'Est Delivery Date :' ?>
                                                                </h6>
                                                            </div>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-muted text-end gap-1"><?= $settings['currency'] ?> <span class="wallet_used">0.00<span></td>
                                        ...
                                        <tfoot>
                                            ...
                                            <tr class="total-price">
                                                ...
                                                <td class="text-end gap-1 fw-bold">
                                ...
                                <button class="block btn btn-primary rounded-pill w-100 mt-4" id="place_order_btn" type="submit" <?= ($is_disabled) ? "disabled" : ""; ?>><?= !empty($this->lang->line('place_order')) ? $this->lang->line('place_order') : 'Place Order' ?>
                               
                                </button>
                                 <!-- <script>
                                 var productIds = <?php echo json_encode($p_id['product_id']); ?>;
                                 var purchaseValue = <?php echo json_encode(format_price($cart['sub_total'])); ?>;
                                document.getElementById('place_order_btn').addEventListener('click', function() {
                                 trackPurchase(productIds, purchaseValue);
                                  });
                            </script> -->
                            </div>
                        </div>
...
<div class="modal fade address_modal" id="address-modal" tabindex="-1">
    <div class="modal-dialog modal-dialog-centered">
        ...
        <div class="modal-header p-3">
                    <h5 class="modal-title"><?= !empty($this->lang->line('shipping_address')) ? $this->lang->line('shipping_address') : 'Shipping Address' ?></h5>
            ...
            <div class="modal-body p-3 pb-0">
                <section id="address_form">
                    ...
                    <div class="col-12 text-right mt-2">
                        ...
                        <a href="#" class="float-end " data-bs-toggle="modal" data-bs-target="#add-address-modal">
                            <?= !empty($this->lang->line('create_a_new_address')) ? $this->lang->line('create_a_new_address') : 'Add New Address' ?>
                        </a>
                        <!-- <a target="_blank" href="<? //= base_url('my-account/manage-address') 
                                                        ?>"><? //= !empty($this->lang->line('create_a_new_address')) ? $this->lang->line('create_a_new_address') : 'Create a New Address' 
                                                            ?></a> -->
             ...
             <div class="modal-footer p-3 pt-0">
                    <div class="d-flex w-100">
                        <button class="submit btn btn-primary btn-sm w-100" id="select_address"><?= !empty($this->lang->line('save')) ? $this->lang->line('save') : 'Save' ?></button>
                    </div>
                   
                    <div class="text-center my-1 w-100">
                        <span data-bs-dismiss="modal" aria-label="Close"><?= !empty($this->lang->line('cancel')) ? $this->lang->line('cancel') : 'Cancel' ?></div>
                    </div>
                </div>
            <!--/.modal-content -->
        </div>
        ...
        <div class="modal-content text-center">
            <div class="modal-body p-4">
                ...
                <section id="promo_code_form">
                    <div class="h4 text-start"><?= !empty($this->lang->line('promocodes')) ? $this->lang->line('promocodes') : 'Promocodes' ?></div>
        ...
        <div class="modal-content">
            <form action="<?= base_url('my-account/add-address') ?>" method="POST" id="add-address-form" class="">
                ...
                <div class="modal-body p-3">
                    <!-- <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button> -->
                        <div class="row">
                            ...
                            <div class="col-md-6 col-sm-12 col-xs-12 form-group d-none">
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12 form-group">
                                <textarea name="address" class="form-control" id="address" cols="30" rows="2" placeholder="#Door no, Street Address, Locality"></textarea>
                            </div>
                            
                            <!-- Commented by @AV -->
                            <!-- <div class="col-md-6 col-sm-12 col-xs-12 form-group city">
                                <select class="form-control city_new" name="city_id" id="city_new">
                            ...
                            <div class="col-md-6 col-sm-12 col-xs-12 form-group area d-none">
                            ...
                            <div class="col-md-6 col-sm-12 col-xs-12 form-group">
                                <input type="number" class="form-control " id="pincode_name" name="pincode_name" placeholder="<?= !empty($this->lang->line('pincode')) ? $this->lang->line('pincode') : 'Zipcode' ?>" />
                            </div>

                            <div class="col-md-6 col-sm-12 col-xs-12 form-group city_name">
                            ...
                            <div class="col-md-6 col-sm-12 col-xs-12 form-group">
                                <input type="text" class="form-control" name="country" id="country" placeholder="<?= !empty($this->lang->line('country')) ? $this->lang->line('country') : 'Country' ?>" value="India" />
                            </div>
                        <div class="col-md-12 col-sm-12 col-xs-12 form-group">
                ...
                <div class="modal-footer p-3">
                    <div class="d-flex w-100">
                        <input type="submit" class="btn btn-primary btn-sm w-100" id="save-address-submit-btn" value="Save" />
                    </div>
                    <div class="text-center">
                        <div id="save-address-result"></div>
                    </div>
                    <div class="text-center my-1 w-100">
                        <span data-bs-dismiss="modal" aria-label="Close">Close</div>
                    </div>
                </div>
             </form>
            <!--/.modal-content -->
