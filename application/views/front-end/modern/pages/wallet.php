                        ...
                        <div class="card">
                            <div class="bg-transparent card-body px-0 py-5">
                                <div class="d-flex justify-content-center flex-column gap-2">
                                    <a href="#" class="btn btn-primary btn-xs rounded-pill mx-1 mb-2 mb-md-0 mx-xl-15" data-bs-toggle="modal" data-bs-target="#myModal"><?= !empty($this->lang->line('add_money')) ? $this->lang->line('add_money') : 'Add Money' ?></a>
