                                            ...
                                            <div id="type_add_html">
                                                ...
                                                <div class="form-group row slider-products d-none">
                                                    ...
                                                    <div class="col-md-12">
                                                        ...
                                                        ?>
                                                        <select name="product_id" id="product_select_id" class="search_admin_product w-100" data-placeholder=" Type to search and select products" onload="multiselect()">
                                                            <?php
                                                                $product_details = fetch_details('products', '', 'id,name');
                                                    ...
                                                    <div class="container-fluid row image-upload-section">
                                                        <div class="col-md-3 col-sm-12 shadow p-3 mb-5 bg-white rounded m-4 text-center grow image">
                                                            <div class='image-upload-div'>
                                                                <img class="img-fluid mb-2" id="slider_uploaded_image" src="" alt="Image Not Found">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
